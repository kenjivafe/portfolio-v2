...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn("gh-cell", className)}
...
>(
  (
    { title = "Contribution Graph", hideMonthLabels = false, className, children, ...props },
    ref
  ) => {
    ...
    return (
      <div
        className={cn("gh-calendar-wrap", className)}
        ref={ref}
        {...props}
      >
      <svg
...
export const ContributionGraphTotalCount = ({
  ...
  return (
    <div className={cn("gh-total-count", className)} {...props}>
      {labels.totalCount
        ? labels.totalCount
...
export const ContributionGraphLegend = ({
  ...
  return (
    <div
      className={cn("gh-legend", className)}
      {...props}
    >
      ...
      {new Array(maxLevel + 1).fill(undefined).map((_, level) =>
        children ? (
          ...
          <svg height={blockSize} key={level} width={blockSize} className="legend-cell">
            <title>{`${level} contributions`}</title>
            <rect
              className={cn("gh-cell")}
              data-level={level}
              height={blockSize}
              rx={blockRadius}
              ry={blockRadius}
